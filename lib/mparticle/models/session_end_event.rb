...
module MParticle
  ...
  class SessionEndEvent
    ...
    attr_accessor :session_duration_ms
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'session_duration_ms')
        self.session_duration_ms = attributes[:'session_duration_ms']
      end
    ...
    def list_invalid_properties
      ...
      if @session_duration_ms.nil?
        invalid_properties.push("invalid value for 'session_duration_ms', session_duration_ms cannot be nil.")
      end
    ...
    def valid?
      return false if @session_duration_ms.nil?
      return true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          session_duration_ms == o.session_duration_ms
    end
    ...
    def hash
      [timestamp_unixtime_ms, event_id, source_message_id, session_id, session_uuid, custom_attributes, location, device_current_state, session_duration_ms].hash
    end
